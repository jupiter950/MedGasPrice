...
def crape_data():
    ...
    med_res = requests.get('https://snowtrace.io/_next/data/routescan:mainnet:55bab5f03cb0aa3a25f65e44882c51d1446fcd29/gastracker.json', cookies=cookies)
    ...
    for item in json.loads(res.text):
        ...
        if serializer.is_valid(raise_exception=True):
            serializer.save()
    print(json.loads(med_res.text)["pageProps"]["values"])
